...
- **00.WBS** — 진행 관리 그 자체(일정·TODO)만 다룸. 기획 내용은 여기 안 옴
  - [01. PM TODO board.md](<00.WBS/01. PM TODO board.md>) · [03. WBS 상세.md](<00.WBS/03. WBS 상세 (기술 레이어별 일정표).md>) · [04. Week 0-3 실행 계획.md](<00.WBS/04. Week 0-3 실행 계획 & 동기화 체크포인트.md>) · [05. 회의록/](<00.WBS/05. 회의록>)(1차 화상회의·타운홀 체크리스트)
