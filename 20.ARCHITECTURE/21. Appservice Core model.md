...
## 0. 제품 정체성 (재확인)
> **2026-09-01 동기화 완료**: [[12. Market Research]]·[[11. KickOFF]] 2절과 동일하게 아래 정체성을 "SAP 옆에 붙는 재고 리플레니시먼트 포인트 솔루션"으로 갱신함(카카오스타일 SAP S/4HANA 실사용 확인됨, 2026-08-29). [[00.README]]·`팀원모집.md`·루트 `README.md`도 같은 패스에서 동기화 완료.
- **만드는 것**: **Fashion AI Agent Appservice**(가칭) — SAP 등 기존 ERP는 그대로 두고 그 옆에 붙는 AI 재고 리플레니시먼트(수요계획+발주승인) 포인트 솔루션, 구현은 Dynamics 365/Dataverse(Power Platform) 기반 PoC
