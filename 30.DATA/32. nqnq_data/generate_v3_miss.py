...
# --- 미달 시나리오 전용: 공급망 이슈 구간 (경미한 미달, 목표 대비 80~90% 타겟) ---
DISRUPTION_WINDOWS = [
    (date(2024, 9, 1), date(2024, 11, 30), 25, 0.65, "Y1 FW 물류 파트너 온보딩 지연"),
    (date(2025, 9, 1), date(2025, 11, 30), 28, 0.62, "Y2 FW 원단 수급 이슈(글로벌 공급망 차질)"),
    (date(2026, 4, 1), date(2026, 8, 9), 45, 0.25, "Y3 여름 시즌 공장 케파 초과(생산 병목)"),
]
